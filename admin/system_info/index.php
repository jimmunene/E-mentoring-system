		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Welcome Content</label>
	             <textarea name="welcome_message" id="" cols="30" rows="10" class="form-control summernote"><?php echo  is_file(base_app."welcome.html") ? file_get_contents(base_app."welcome.html") : '' ?></textarea>
			</div>
			<div class="form-group">
